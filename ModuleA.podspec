...
Pod::Spec.new do |s|
  ...
  s.name         = "BFModuleA"
  s.version      = "0.0.1"
  s.summary      = "A short description of BFModuleA."
  ...
  s.author             = { "qifeibo" => "616532237@qq.com" }
  # Or just: s.author    = "qifeibo"
  # s.authors            = { "qifeibo" => "616532237@qq.com" }
  # s.social_media_url   = "http://twitter.com/qifeibo"
